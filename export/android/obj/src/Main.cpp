...
{
		HX_STACK_FRAME("Main","init",0xea732345,"Main.init","Main.hx",42,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_ARG(E,"E")
		HX_STACK_LINE(43)
...
{
		HX_STACK_FRAME("Main","setupGame",0x7f7688ba,"Main.setupGame","Main.hx",52,0x087e5c05)
		HX_STACK_THIS(this)
		HX_STACK_LINE(53)
		...
		HX_STACK_LINE(64)
		int tmp12 = ::Reg_obj::FrameRate;		HX_STACK_VAR(tmp12,"tmp12");
		HX_STACK_LINE(64)
		int tmp13 = ::Reg_obj::DrawRate;		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(64)
...
Void Main_obj::main( ){
{
		HX_STACK_FRAME("Main","main",0xed0e206e,"Main.main","Main.hx",23,0x087e5c05)
		HX_STACK_LINE(24)
		::openfl::_legacy::display::MovieClip tmp = ::openfl::_legacy::Lib_obj::get_current();		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(24)
