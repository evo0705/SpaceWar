...
::BulletProperties FlxRandom_obj::getObject_BulletProperties( Array< ::Dynamic > Objects,hx::Null< int >  __o_StartIndex,hx::Null< int >  __o_EndIndex){
int StartIndex = __o_StartIndex.Default(0);
int EndIndex = __o_EndIndex.Default(0);
	HX_STACK_FRAME("flixel.util.FlxRandom","getObject_BulletProperties",0x0850bcf2,"flixel.util.FlxRandom.getObject_BulletProperties","flixel/util/FlxRandom.hx",289,0xd3ba8ba3)
	HX_STACK_ARG(Objects,"Objects")
	HX_STACK_ARG(StartIndex,"StartIndex")
	HX_STACK_ARG(EndIndex,"EndIndex")
{
		HX_STACK_LINE(290)
		::BulletProperties selected = null();		HX_STACK_VAR(selected,"selected");
		HX_STACK_LINE(292)
		...
		if ((tmp)){
			...
			if ((tmp4)){
				...
				HX_STACK_LINE(308)
				int tmp7 = (Objects->length - (int)1);		HX_STACK_VAR(tmp7,"tmp7");
				HX_STACK_LINE(308)
			...
			HX_STACK_LINE(313)
			::BulletProperties tmp9 = Objects->__get(tmp8).StaticCast< ::BulletProperties >();		HX_STACK_VAR(tmp9,"tmp9");
			HX_STACK_LINE(313)
			selected = tmp9;
		}
		HX_STACK_LINE(316)
		::BulletProperties tmp1 = selected;		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(316)
		return tmp1;
	}
}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(FlxRandom_obj,getObject_BulletProperties,return )
...
bool FlxRandom_obj::__GetStatic(const ::String &inName, Dynamic &outValue, hx::PropertyAccess inCallProp)
{
	...
	case 22:
		...
		break;
	case 26:
		if (HX_FIELD_EQ(inName,"getObject_BulletProperties") ) { outValue = getObject_BulletProperties_dyn(); return true;  }
	}
	return false;
}
...
static ::String sStaticFields[] = {
	HX_HCSTRING("getObject_BulletProperties","\xbf","\x37","\x1e","\xe0"),
