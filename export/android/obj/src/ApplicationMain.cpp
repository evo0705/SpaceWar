...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(29)
		::openfl::_legacy::Lib_obj::setPackage(HX_HCSTRING("HaxeFlixel","\x42","\x8f","\x0c","\xac"),HX_HCSTRING("SpaceWarV2","\xbe","\x5f","\x09","\x1d"),HX_HCSTRING("com.example.myapp","\x84","\x30","\x57","\xc1"),HX_HCSTRING("0.0.1","\x35","\x3d","\xc8","\xc1"));
		HX_STACK_LINE(114)
		...
		Void run(){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","ApplicationMain.hx",50,0x0780ded5)
			{
				HX_STACK_LINE(52)
		...
		HX_STACK_LINE(50)
		::openfl::_legacy::Lib_obj::create( Dynamic(new _Function_1_1()),(int)0,(int)0,(int)60,(int)0,tmp22,HX_HCSTRING("SpaceWarV2","\xbe","\x5f","\x09","\x1d"),null(),null());
	}
return null();
}
