...
HX_DECLARE_CLASS1(utilities,FPS)
namespace utilities{
...
class HXCPP_CLASS_ATTRIBUTES  FPS_obj : public ::flixel::text::FlxText_obj{
	...
	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="utilities.FPS")
