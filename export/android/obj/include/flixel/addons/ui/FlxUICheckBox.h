...
class HXCPP_CLASS_ATTRIBUTES  FlxUICheckBox_obj : public ::flixel::addons::ui::FlxUIGroup_obj{
	public:
		...
		FlxUICheckBox_obj();
		Void __construct(hx::Null< Float >  __o_X,hx::Null< Float >  __o_Y,Dynamic Box,Dynamic Check,::String Label,Dynamic __o_LabelW,cpp::ArrayBase Params,Dynamic Callback);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true,const char *inName="flixel.addons.ui.FlxUICheckBox")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		static hx::ObjectPtr< FlxUICheckBox_obj > __new(hx::Null< Float >  __o_X,hx::Null< Float >  __o_Y,Dynamic Box,Dynamic Check,::String Label,Dynamic __o_LabelW,cpp::ArrayBase Params,Dynamic Callback);
