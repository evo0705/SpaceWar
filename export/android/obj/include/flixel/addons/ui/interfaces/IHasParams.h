...
class HXCPP_CLASS_ATTRIBUTES  IHasParams_obj : public hx::Interface{
	public:
		...
		virtual cpp::ArrayBase set_params( cpp::ArrayBase p)=0;
		virtual Dynamic set_params_dyn()=0;
};

#define DELEGATE_flixel_addons_ui_interfaces_IHasParams \
virtual cpp::ArrayBase set_params( cpp::ArrayBase p) { return mDelegate->set_params(p);}  \
