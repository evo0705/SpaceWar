...
class HXCPP_CLASS_ATTRIBUTES  FlxRandom_obj : public hx::Object{
	...
	public:
		...
		static void __boot();
		static ::BulletProperties getObject_BulletProperties( Array< ::Dynamic > Objects,hx::Null< int >  StartIndex,hx::Null< int >  EndIndex);
		static Dynamic getObject_BulletProperties_dyn();
