...
class AssetData {
	...
	public static function initialize():Void {
		...
		if (!initialized) {
			...
			type.set ("assets/images/b-0001.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/blue2.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/blue_fire.png", "assets/images/blue_fire.png");
			type.set ("assets/images/blue_fire.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/bullet_0001.png", "assets/images/bullet_0001.png");
			type.set ("assets/images/bullet_0001.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/bullet_0002.png", "assets/images/bullet_0002.png");
			type.set ("assets/images/bullet_0002.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/button-0001.png", "assets/images/button-0001.png");
			type.set ("assets/images/button-0001.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/empty_host.png", "assets/images/empty_host.png");
			type.set ("assets/images/empty_host.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/firing_host.png", "assets/images/firing_host.png");
			type.set ("assets/images/firing_host.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/green_fire.png", "assets/images/green_fire.png");
			type.set ("assets/images/green_fire.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/images-go-here.txt", "assets/images/images-go-here.txt");
			type.set ("assets/images/images-go-here.txt", Reflect.field (AssetType, "text".toUpperCase ()));
			path.set ("assets/images/particle_0001.png", "assets/images/particle_0001.png");
			type.set ("assets/images/particle_0001.png", Reflect.field (AssetType, "image".toUpperCase ()));
			...
			type.set ("assets/images/ship_0001.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/simple_laser_anim.png", "assets/images/simple_laser_anim.png");
			type.set ("assets/images/simple_laser_anim.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/weaponhost_0001.png", "assets/images/weaponhost_0001.png");
			type.set ("assets/images/weaponhost_0001.png", Reflect.field (AssetType, "image".toUpperCase ()));
			path.set ("assets/images/yellow_ring.png", "assets/images/yellow_ring.png");
			type.set ("assets/images/yellow_ring.png", Reflect.field (AssetType, "image".toUpperCase ()));
