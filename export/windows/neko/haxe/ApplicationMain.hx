...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "SpaceWarV2", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "SpaceWarV2";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "SpaceWarV2", null, { width: 480, height: 640 });
